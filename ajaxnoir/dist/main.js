    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
        ...
        success: function(data) {
            ...
            if(json.total_results) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(that.sel).html("<p>No information available</p>");
            }
        },
        error: function(xhr, status, error) {
            // Error
            console.log("MovieInfo Error");
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(that.sel).html("<p>Unable to communicate<br>with themoviedb.org</p>");
        }
    });
}
...
MovieInfo.prototype.displayMovieInfo = function (html) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.sel).html(final_html);
    var info = jquery__WEBPACK_IMPORTED_MODULE_0___default()("ul > li:first-child");
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("ul > li > a").click(function (event) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().siblings().children("div").fadeOut(750);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().siblings().children("a").children().css("opacity", "0.3");

        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().children("div").fadeIn(750);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().children("a").children().css("opacity", "1");
    });
};
...
Stars.prototype.installListener = function(row, star, id, rating) {
    ...
    star.click(function() {
        var table = jquery__WEBPACK_IMPORTED_MODULE_0___default()(that.sel + " table");
        jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
            url: "post/stars.php",
...
Stars.prototype.message = function(message) {
    // do something...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.sel + " .message").html(message);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.sel + " .message").delay(2000).show().delay(2000).fadeOut(1000);

}

Stars.prototype.updateTable = function(table){
    var that = this;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.sel + " .table").hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.sel + " .table").html(table);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.sel + " .table").fadeIn(1000);
}
